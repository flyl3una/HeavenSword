...
'''
python D:\work\pycharm\workspace\github\HeavenSword\core\worker.py {'task_id': 1, 'domain_brute_thread': 6, 'target': 'http://www.runoob.com', 'port_scan_thread': 4, 'spider_flag': true, 'port_scan_flag': true, 'domain_brute_flag': true, 'spider_thread': 80, 'exploit_flag': true, 'port_scan_model': 'usually', 'finger_flag': true}
'''
